...
public class AppSettings extends AppSettingsBase {
    ...
    public long getFroodyUserId() {
        return getLong(_prefApp, R.string.pref_key__user_id, -1);
    }
    ...
    public void setFroodyUserId(long value) {
        setLong(_prefApp, R.string.pref_key__user_id, value);
    }

    public boolean isDevDebugModeEnabled() {
        return getBool(_prefApp, R.string.pref_key__dev_mode_debugging, false);
    }

    public void setDevDebugModeEnabled(boolean value) {
        setBool(_prefApp, R.string.pref_key__dev_mode_debugging, value);
    }


    public String getFroodyServer() {
        return getString(_prefApp, R.string.pref_key__froody_server, rstr(R.string.server_default));
    }
    ...
    public double getLastMapLocationLatitude() {
        return getDouble(_prefApp, R.string.pref_key__last_map_location_latitude, 0);
    }

    public double getLastMapLocationLongitude() {
        return getDouble(_prefApp, R.string.pref_key__last_map_location_longitude, 0);
    }

    public int getLastMapLocationZoom() {
        return getInt(_prefApp, R.string.pref_key__last_map_location_zoom, 0);
    }

    public void setLastMapLocation(double lat, double lng, int zoom) {
        setDouble(_prefApp, R.string.pref_key__last_map_location_latitude, lat);
        setDouble(_prefApp, R.string.pref_key__last_map_location_longitude, lng);
        setInt(_prefApp, R.string.pref_key__last_map_location_zoom, zoom);
    }

    public int getLastCertification() {
        return getInt(_prefApp, R.string.pref_key__entry__last_certification, 0);
    }

    public void setLastCertification(int value) {
        setInt(_prefApp, R.string.pref_key__entry__last_certification, value);
    }

    public String getLastContactInfo() {
        return getString(_prefApp, R.string.pref_key__entry__last_contact_info, "");
    }

    public void setLastContactInfo(String value) {
        setString(_prefApp, R.string.pref_key__entry__last_contact_info, value);
    }

    public int getLastDistribution() {
        return getInt(_prefApp, R.string.pref_key__entry__last_distribution, 0);
    }

    public void setLastSelectedEntryTypes(ArrayList<Integer> values) {
        setIntList(_prefApp, R.string.pref_key__entry__last_selected_entry_types, values);
    }

    public ArrayList<Integer> getLastSelectedEntryTypes() {
        return getIntList(_prefApp, R.string.pref_key__entry__last_selected_entry_types);
    }

    public void setLastDistribution(int value) {
        setInt(_prefApp, R.string.pref_key__entry__last_distribution, value);
    }

    public boolean getAllowLocationListeningGps() {
        return getBool(_prefApp, R.string.pref_key__allow_location_listening_gps, true);
    }

    public boolean getAllowLocationListeningNetwork() {
        return getBool(_prefApp, R.string.pref_key__allow_location_listening_net, true);
    }
    ...
    public void setLastFoundLocation(String geohash, String address) {
        setString(_prefApp, R.string.pref_key__last_found_location_address, address);
        setString(_prefApp, R.string.pref_key__last_found_location_geohash, geohash);
    }

    public String[] getLastFoundLocation() {
        return new String[]{
                getString(_prefApp, R.string.pref_key__last_found_location_geohash, ""),
                getString(_prefApp, R.string.pref_key__last_found_location_address, "")
        };
    }

    public boolean isAppFirstStart() {
        return getBool(_prefApp, R.string.pref_key__app_first_start, true);
    }

    public void setAppFirstStart(boolean value) {
        setBool(_prefApp, R.string.pref_key__app_first_start, value);
    }
    ...
    public void setEntryTypeSelectionDialogTabLastUsed(int value) {
        setInt(_prefApp, R.string.pref_key__entry_type_selection_dialog__tab_last_used, value);
    }

    public int getEntryTypeSelectionDialogTabLastUsed() {
        return getInt(_prefApp, R.string.pref_key__entry_type_selection_dialog__tab_last_used, 0);
    }
